package com.JwtProject.jwtapp.api;
...
@RestController
@RequestMapping("/api")
@RequiredArgsConstructor   ///private final inject eder
public class UserController {
    ...
    public ResponseEntity<AppRole> saveRole(@RequestBody RoleToUserForm form){
